...
describe('UseKeyModal', () => {
  ...
  it('omits the attribution override from every standard Claude Code setup form', async () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkAnthropicTest,
  ...
  it('renders Grok Build and OpenCode setup for Grok groups', async () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkGrokTest,
        baseUrl: 'https://example.com/v1',
        platform: 'grok'
      },
      global: {
  ...
  it('renders copyable Claude Code setup through the Grok Messages gateway', async () => {
    ...
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkGrokClaude,
        baseUrl: 'https://example.com/v1',
        platform: 'grok'
      },
      global: {
  ...
  it('renders Codex custom provider setup through the Grok Responses gateway', async () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkGrokCodex,
        baseUrl: 'https://example.com/v1',
        platform: 'grok'
      },
      global: {
  ...
  it('offers a downloadable Codex catalog for Composite API keys', async () => {
    ...
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkCompositeTest,
        baseUrl: 'https://example.com/v1',
        platform: 'composite'
      },
      global: {
  ...
  it('derives OpenAI Codex reasoning effort from the selected catalog descriptor', async () => {
    ...
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: FIXTURE_APIKEY_SkOpenaiTest,
        baseUrl: 'https://example.com/v1',
        platform: 'openai'
      },
      global: {
