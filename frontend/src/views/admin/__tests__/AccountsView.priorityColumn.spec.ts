...
const FIXTURE_TOKEN_TestToken = ['test-token'].join('');import { beforeEach, describe, expect, it, vi } from 'vitest'
...
vi.mock('@/stores/auth', () => ({
  useAuthStore: () => ({ token: FIXTURE_TOKEN_TestToken, isSimpleMode: false })
}))
