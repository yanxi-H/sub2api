    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <UserDashboardModelRecommendations
          v-if="recommendationsLoading || recommendations || recommendationsError"
...
import { usageAPI, type CodexRadarDashboardRecommendations, type UserDashboardStats as UserStatsType } from '@/api/usage'
import AppLayout from '@/components/layout/AppLayout.vue'
import LoadingSpinner from '@/components/common/LoadingSpinner.vue'
import UserDashboardStats from '@/components/user/dashboard/UserDashboardStats.vue'
import UserDashboardModelRecommendations from '@/components/user/dashboard/UserDashboardModelRecommendations.vue'
...
const recommendations = ref<CodexRadarDashboardRecommendations | null>(null)
...
const loadRecommendations = async () => {
  ...
  try {
    recommendations.value = await usageAPI.getDashboardRecommendations()
  } catch (error) {
    console.warn('Failed to load model recommendations:', error)
