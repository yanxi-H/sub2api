...
codexDeviceEmpty: '暂无观测记录：部署新版本后，让用户正常使用一段时间（产生 Codex 流量）再点击获取',        codexDeviceIdHint: '列出网关从各 API Key 流量中观测到的 x-codex-installation-id。选择后指纹收敛(device 档)将使用该真实设备 ID。',
