...
func (c opsCleanupDeletedCounts) String() string {
	return fmt.Sprintf(
		"error_logs=%d request_performance=%d ingress_rejects=%d alert_events=%d system_logs=%d log_audits=%d system_metrics=%d hourly_preagg=%d daily_preagg=%d",
		c.errorLogs,
		c.requestPerformance,
		c.ingressRejects,
		c.alertEvents,
		c.systemLogs,
		c.logAudits,
