...
// is third from last (native_compaction_v2 and created_at follow it).
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.GreaterOrEqual(t, len(usageLogInsertArgTypes), 3,
		"arg-type table must include session_id, native_compaction_v2 and created_at")
	...
	// created_at is last; native_compaction_v2 sits before it; session_id precedes both.
