...
func (h *OpenAIGatewayHandler) acquireResponsesAccountSlot(
	...
	return h.acquireResponsesAccountSlotForLaneResult(
...
func (h *OpenAIGatewayHandler) acquireResponsesAccountSlotForLane(
	...
	release, result := h.acquireResponsesAccountSlotForLaneResult(
		c, groupID, sessionHash, selection, lane, reqStream, streamStarted, reqLog,
	)
