...
func ProvideAdminHandlers(
	codexSeenDeviceRecorder service.CodexSeenDeviceRecorder,
	...
	return &AdminHandlers{
		...
		CodexDevice:            codexDeviceHandler,
		Ops:                    opsHandler,
...
func ProvideUsageHandler(
	...
	opsService *service.OpsService,
	settingService *service.SettingService,
	codexRadarService *service.CodexRadarService,
) *UsageHandler {
	return NewUsageHandler(usageService, apiKeyService, opsService, settingService, codexRadarService)
}
...
func ProvideHandlers(
	...
	return &Handlers{
		...
		Admin:            adminHandlers,
		CodexDevice:      adminHandlers.CodexDevice,
